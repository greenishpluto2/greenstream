 ...
 */
export function getStreamDirectories(assetsPath: string): string[] {
  const streamDirs = fs
 ...
 */
export function collectSegmentFiles(streamDirs: string[], assetsPath: string): string[] {
 ...
 */
export function updatePlaylistContent(playlistContent: string, streamDir: string, blobMappings: BlobMapping): string {
